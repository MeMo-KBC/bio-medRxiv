...
from MeMoKBC.pipeline.lfs.name_short_task_lfs import NameAbb_Task_lfs
...
def apply_lf(session, parallel: int=12):
    ...
    labeler.apply(split=0, lfs=[dummy_lfs, NameAbb_Task_lfs], train=True, parallelism=parallel)
